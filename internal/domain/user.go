...
const (
	RoleVoyageCoordinator Role = "voyage_coordinator"
	RoleVesselCaptain     Role = "vessel_captain"
	RoleFisheriesOfficer  Role = "fisheries_officer"
...
func (u User) Validate() error {
	...
	switch u.Role {
	case RoleVoyageCoordinator, RoleVesselCaptain, RoleFisheriesOfficer, RoleComplianceAuditor:
	default:
